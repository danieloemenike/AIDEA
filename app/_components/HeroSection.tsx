  ...
  return (
      <section className='container h-[50%] grid grid-cols-2  '>
          <div className="   w-[95%] gap-2 p-6">
              ...
              Your <span className= "bg-clip-text font-blanka text-transparent bg-gradient-to-r from-blue-500 to-cyan-500"> Personal </span> <span className='font-blanka tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500'>AI </span> Assistant: <br/> Elevating Efficiency & Unlocking Potential.
              </h2>
              </div>
              ...
              <div className='mt-[20px] w-fit p-2 rounded-lg pl-2 pr-2 shadow-2xl  flex items-center bg-gradient-to-r from-blue-500 to-blue-800'>
